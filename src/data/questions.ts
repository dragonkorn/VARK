...
export const QUESTIONS: Question[] = [
  {
    ...
    options: [
      { modality: 'V', text: 'ดูภาพหน้าจอและไอคอนที่สรุปขั้นตอนไว้' },
      { modality: 'A', text: 'ให้เพื่อนร่วมงานที่ใช้เป็นแล้วอธิบายให้ฟัง' },
      { modality: 'R', text: 'อ่านคู่มือการใช้งานทีละหัวข้อ' },
      { modality: 'K', text: 'ลองกดใช้งานจริงในระบบทดสอบไปเรื่อย ๆ' },
    ],
  },
  {
    id: 2,
  ...
  {
    id: 4,
    prompt: 'เลือกหลักสูตรอบรมให้ตัวเอง คุณดูอะไรเป็นหลัก',
    options: [
  ...
  },
  {
    ...
    options: [
      ...
      { modality: 'A', text: 'เข้าฟังการชี้แจงและถามคำถามในที่ประชุม' },
      { modality: 'R', text: 'อ่านเอกสารนโยบายฉบับเต็ม' },
      { modality: 'K', text: 'ลองซ้อมจากเคสจริงว่าถ้าเจอสถานการณ์นี้ต้องทำอย่างไร' },
    ],
  },
  {
    id: 6,
  ...
  },
  {
    ...
    options: [
      ...
      { modality: 'K', text: 'ทำข้อสอบเก่าและฝึกปฏิบัติจนคล่อง' },
    ],
  },
  {
    id: 11,
    ...
    options: [
      { modality: 'V', text: 'วาดภาพให้เห็นภาพรวมทั้งกระบวนการ' },
